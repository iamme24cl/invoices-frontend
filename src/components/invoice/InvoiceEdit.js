      ...
      <>
        <div className="h-screen flex flex-col mt-10 sm:mt-16 items-center">
          ...
          <form onSubmit={this.handleSubmit} className="w-full max-w-lg p-1 pb-16">
            <div className="flex flex-wrap lg:-mx-4 mb-6">
            ...
            {items.map((val, idx) => {
              return (
                <div className='flex flex-wrap lg:-mx-4 mb-6' key={`${idx}-items`}>
            ...
            <button className="bg-gray-400 hover:bg-gray-500 text-gray-800 ml-3 lg:-ml-1 py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
              Submit
            </button>          
          </form>
        </div>
